...
var AppComponent = /** @class */ (function () {
    function AppComponent(dialog, http, db) {
        ...
        var yad2ApartmentsCollections = this.db.collection('/yad2_apartments', function (ref) { return ref.where('processed', '<', 18); });
    ...
    AppComponent.prototype.doApartmentsFilter = function (apartments, addressesById, maxWalkingMinutes, maxPrice, lastUpdateDays, search, handledBy) {
        var self = this;
        var ret = [];
    ...
    AppComponent.prototype.getStats = function (apartments) {
